  ...
  return (
    ...
    >
      ...
      <motion.p variants={item} className="xl:text-2xl md:text-base text-sm xl:leading-9 text-medium">
        Hello, I’m Aliza! Passionate in frontend developer and committed to continuously expanding my knowledge and skills in frontend development, deliver clean code and learning new technology. 
      </motion.p>
    </motion.div>
  );
};
