...
const HomeContent = () => {
  ...
  return (
    <>
      ...
      >
        <h2 className="text-primary font-extrabold xl:text-5xl md:text-4xl text-xl">Aliza Nurfitrian Meizahra</h2>
      ...
      >
        <span className="font-semibold">Frontend Developer</span> with 2+ years of experience in developing websites and mobile applications
      </motion.p>
    </>
  );
};
